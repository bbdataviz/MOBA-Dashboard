...
### Load data subset
# length (box)
source4_1 = pd.read_csv('data/CC388_len_1.csv', encoding='utf-8')
source5_1 = pd.read_csv('data/CC389_len_1.csv', encoding='utf-8')
source6_1 = pd.read_csv('data/CC390_len_1.csv', encoding='utf-8')
source7_1 = pd.read_csv('data/CC391_len_1.csv', encoding='utf-8')
source8_1 = pd.read_csv('data/CC392_len_1.csv', encoding='utf-8')
source4_2 = pd.read_csv('data/CC388_len_2.csv', encoding='utf-8')
source5_2 = pd.read_csv('data/CC389_len_2.csv', encoding='utf-8')
source6_2 = pd.read_csv('data/CC390_len_2.csv', encoding='utf-8')
source7_2 = pd.read_csv('data/CC391_len_2.csv', encoding='utf-8')
source8_2 = pd.read_csv('data/CC392_len_2.csv', encoding='utf-8')
source4_3 = pd.read_csv('data/CC141_len_3.csv', encoding='utf-8')
source5_3 = pd.read_csv('data/CC142_len_3.csv', encoding='utf-8')
source6_3 = pd.read_csv('data/CC143_len_3.csv', encoding='utf-8')
source7_3 = pd.read_csv('data/CC144_len_3.csv', encoding='utf-8')
source8_3 = pd.read_csv('data/CC145_len_3.csv', encoding='utf-8')
# weight (box)
source4_1w = pd.read_csv('data/CC388_wei_1.csv', encoding='utf-8')
source5_1w = pd.read_csv('data/CC389_wei_1.csv', encoding='utf-8')
source6_1w = pd.read_csv('data/CC390_wei_1.csv', encoding='utf-8')
source7_1w = pd.read_csv('data/CC391_wei_1.csv', encoding='utf-8')
source8_1w = pd.read_csv('data/CC392_wei_1.csv', encoding='utf-8')
source4_2w = pd.read_csv('data/CC388_wei_2.csv', encoding='utf-8')
source5_2w = pd.read_csv('data/CC389_wei_2.csv', encoding='utf-8')
source6_2w = pd.read_csv('data/CC390_wei_2.csv', encoding='utf-8')
source7_2w = pd.read_csv('data/CC391_wei_2.csv', encoding='utf-8')
source8_2w = pd.read_csv('data/CC392_wei_2.csv', encoding='utf-8')
source4_3w = pd.read_csv('data/CC141_wei_3.csv', encoding='utf-8')
source5_3w = pd.read_csv('data/CC142_wei_3.csv', encoding='utf-8')
source6_3w = pd.read_csv('data/CC143_wei_3.csv', encoding='utf-8')
source7_3w = pd.read_csv('data/CC144_wei_3.csv', encoding='utf-8')
source8_3w = pd.read_csv('data/CC145_wei_3.csv', encoding='utf-8')
# length (histo)
source4_1h = pd.read_csv('data/CC388_len_1h.csv', encoding='utf-8')
source5_1h = pd.read_csv('data/CC389_len_1h.csv', encoding='utf-8')
source6_1h = pd.read_csv('data/CC390_len_1h.csv', encoding='utf-8')
source7_1h = pd.read_csv('data/CC391_len_1h.csv', encoding='utf-8')
source8_1h = pd.read_csv('data/CC392_len_1h.csv', encoding='utf-8')
source4_2h = pd.read_csv('data/CC388_len_2h.csv', encoding='utf-8')
source5_2h = pd.read_csv('data/CC389_len_2h.csv', encoding='utf-8')
source6_2h = pd.read_csv('data/CC390_len_2h.csv', encoding='utf-8')
source7_2h = pd.read_csv('data/CC391_len_2h.csv', encoding='utf-8')
source8_2h = pd.read_csv('data/CC392_len_2h.csv', encoding='utf-8')
source4_3h = pd.read_csv('data/CC141_len_3h.csv', encoding='utf-8')
source5_3h = pd.read_csv('data/CC142_len_3h.csv', encoding='utf-8')
source6_3h = pd.read_csv('data/CC143_len_3h.csv', encoding='utf-8')
source7_3h = pd.read_csv('data/CC144_len_3h.csv', encoding='utf-8')
source8_3h = pd.read_csv('data/CC145_len_3h.csv', encoding='utf-8')
# weigth (histo)
source4_1wh = pd.read_csv('data/CC388_wei_1h.csv', encoding='utf-8')
source5_1wh = pd.read_csv('data/CC389_wei_1h.csv', encoding='utf-8')
source6_1wh = pd.read_csv('data/CC390_wei_1h.csv', encoding='utf-8')
source7_1wh = pd.read_csv('data/CC391_wei_1h.csv', encoding='utf-8')
source8_1wh = pd.read_csv('data/CC392_wei_1h.csv', encoding='utf-8')
source4_2wh = pd.read_csv('data/CC388_wei_2h.csv', encoding='utf-8')
source5_2wh = pd.read_csv('data/CC389_wei_2h.csv', encoding='utf-8')
source6_2wh = pd.read_csv('data/CC390_wei_2h.csv', encoding='utf-8')
source7_2wh = pd.read_csv('data/CC391_wei_2h.csv', encoding='utf-8')
source8_2wh = pd.read_csv('data/CC392_wei_2h.csv', encoding='utf-8')
source4_3wh = pd.read_csv('data/CC141_wei_3h.csv', encoding='utf-8')
source5_3wh = pd.read_csv('data/CC142_wei_3h.csv', encoding='utf-8')
source6_3wh = pd.read_csv('data/CC143_wei_3h.csv', encoding='utf-8')
source7_3wh = pd.read_csv('data/CC144_wei_3h.csv', encoding='utf-8')
source8_3wh = pd.read_csv('data/CC145_wei_3h.csv', encoding='utf-8')
# Sex
source_sex = pd.read_csv('data/girls_boys.csv', encoding='utf-8')
...
sub_CC388_len_1.to_csv('data/
CC388_len_1.csv', index=False, encoding='utf-8') 
...
sub_CC389_len_1.to_csv('data/
CC389_len_1.csv', index=False, encoding='utf-8') 
...
sub_CC390_len_1.to_csv('data/
CC390_len_1.csv', index=False, encoding='utf-8') 
...
sub_CC391_len_1.to_csv('data/
CC391_len_1.csv', index=False, encoding='utf-8') 
...
sub_CC392_len_1.to_csv('data/
CC392_len_1.csv', index=False, encoding='utf-8')
# PNVP
...
sub_CC388_len_2.to_csv('data/
CC388_len_2.csv', index=False, encoding='utf-8') 
...
sub_CC389_len_2.to_csv('data/
CC389_len_2.csv', index=False, encoding='utf-8') 
...
sub_CC390_len_2.to_csv('data/
CC390_len_2.csv', index=False, encoding='utf-8') 
...
sub_CC391_len_2.to_csv('data/
CC391_len_2.csv', index=False, encoding='utf-8') 
...
sub_CC392_len_2.to_csv('data/
CC392_len_2.csv', index=False, encoding='utf-8')
...
sub_CC141_len_3.to_csv('data/
CC141_len_3.csv', index=False, encoding='utf-8') 
...
sub_CC142_len_3.to_csv('data/
CC142_len_3.csv', index=False, encoding='utf-8') 
...
sub_CC143_len_3.to_csv('data/
CC143_len_3.csv', index=False, encoding='utf-8') 
...
sub_CC144_len_3.to_csv('data/
CC144_len_3.csv', index=False, encoding='utf-8') 
...
sub_CC145_len_3.to_csv('data/
CC145_len_3.csv', index=False, encoding='utf-8')
### DD13 = birth weight
# No NVP
...
sub_CC388_wei_1.to_csv('data/
CC388_wei_1.csv', index=False, encoding='utf-8') 
...
sub_CC389_wei_1.to_csv('data/
CC389_wei_1.csv', index=False, encoding='utf-8') 
...
sub_CC390_wei_1.to_csv('data/
CC390_wei_1.csv', index=False, encoding='utf-8') 
...
sub_CC391_wei_1.to_csv('data/
CC391_wei_1.csv', index=False, encoding='utf-8') 
...
sub_CC392_wei_1.to_csv('data/
CC392_wei_1.csv', index=False, encoding='utf-8') 
# NVP
...
sub_CC388_wei_2.to_csv('data/
CC388_wei_2.csv', index=False, encoding='utf-8') 
...
sub_CC389_wei_2.to_csv('data/
CC389_wei_2.csv', index=False, encoding='utf-8') 
...
sub_CC390_wei_2.to_csv('data/
CC390_wei_2.csv', index=False, encoding='utf-8') 
...
sub_CC391_wei_2.to_csv('data/
CC391_wei_2.csv', index=False, encoding='utf-8') 
...
sub_CC392_wei_2.to_csv('data/
CC392_wei_2.csv', index=False, encoding='utf-8') 
# hospitalized due to PNVP
...
sub_CC141_wei_3.to_csv('data/
CC141_wei_3.csv', index=False, encoding='utf-8') 
...
sub_CC142_wei_3.to_csv('data/
CC142_wei_3.csv', index=False, encoding='utf-8') 
...
sub_CC143_wei_3.to_csv('data/
CC143_wei_3.csv', index=False, encoding='utf-8') 
...
sub_CC144_wei_3.to_csv('data/
CC144_wei_3.csv', index=False, encoding='utf-8') 
...
sub_CC145_wei_3.to_csv('data/
CC145_wei_3.csv', index=False, encoding='utf-8') 
...
sub_CC388_len_1h.to_csv('data/
CC388_len_1h.csv', index=False, encoding='utf-8') 
...
sub_CC389_len_1h.to_csv('data/
CC389_len_1h.csv', index=False, encoding='utf-8') 
...
sub_CC390_len_1h.to_csv('data/
CC390_len_1h.csv', index=False, encoding='utf-8') 
...
sub_CC391_len_1h.to_csv('data/
CC391_len_1h.csv', index=False, encoding='utf-8') 
...
sub_CC392_len_1h.to_csv('data/
CC392_len_1h.csv', index=False, encoding='utf-8')
# PNVP
...
sub_CC388_len_2h.to_csv('data/
CC388_len_2h.csv', index=False, encoding='utf-8') 
...
sub_CC389_len_2h.to_csv('data/
CC389_len_2h.csv', index=False, encoding='utf-8') 
...
sub_CC390_len_2h.to_csv('data/
CC390_len_2h.csv', index=False, encoding='utf-8') 
...
sub_CC391_len_2h.to_csv('data/
CC391_len_2h.csv', index=False, encoding='utf-8') 
...
sub_CC392_len_2h.to_csv('data/
CC392_len_2h.csv', index=False, encoding='utf-8')
# hospitalized due to PNVP 
...
sub_CC141_len_3h.to_csv('data/
CC141_len_3h.csv', index=False, encoding='utf-8') 
...
sub_CC142_len_3h.to_csv('data/
CC142_len_3h.csv', index=False, encoding='utf-8') 
...
sub_CC143_len_3h.to_csv('data/
CC143_len_3h.csv', index=False, encoding='utf-8') 
...
sub_CC144_len_3h.to_csv('data/
CC144_len_3h.csv', index=False, encoding='utf-8') 
...
sub_CC145_len_3h.to_csv('data/
CC145_len_3h.csv', index=False, encoding='utf-8')
### DD13 = birth weight
# No NVP
...
sub_CC388_wei_1h.to_csv('data/
CC388_wei_1h.csv', index=False, encoding='utf-8') 
...
sub_CC389_wei_1h.to_csv('data/
CC389_wei_1h.csv', index=False, encoding='utf-8') 
...
sub_CC390_wei_1h.to_csv('data/
CC390_wei_1h.csv', index=False, encoding='utf-8') 
...
sub_CC391_wei_1h.to_csv('data/
CC391_wei_1h.csv', index=False, encoding='utf-8') 
...
sub_CC392_wei_1h.to_csv('data/
CC392_wei_1h.csv', index=False, encoding='utf-8') 
# NVP
...
sub_CC388_wei_2h.to_csv('data/
CC388_wei_2h.csv', index=False, encoding='utf-8') 
...
sub_CC389_wei_2h.to_csv('data/
CC389_wei_2h.csv', index=False, encoding='utf-8') 
...
sub_CC390_wei_2h.to_csv('data/
CC390_wei_2h.csv', index=False, encoding='utf-8') 
...
sub_CC391_wei_2h.to_csv('data/
CC391_wei_2h.csv', index=False, encoding='utf-8') 
...
sub_CC392_wei_2h.to_csv('data/
CC392_wei_2h.csv', index=False, encoding='utf-8') 
# hospitalized due to PNVP
...
sub_CC141_wei_3h.to_csv('data/
CC141_wei_3h.csv', index=False, encoding='utf-8') 
...
sub_CC142_wei_3h.to_csv('data/
CC142_wei_3h.csv', index=False, encoding='utf-8') 
...
sub_CC143_wei_3h.to_csv('data/
CC143_wei_3h.csv', index=False, encoding='utf-8') 
...
sub_CC144_wei_3h.to_csv('data/
CC144_wei_3h.csv', index=False, encoding='utf-8') 
...
sub_CC145_wei_3h.to_csv('data/
CC145_wei_3h.csv', index=False, encoding='utf-8') 
